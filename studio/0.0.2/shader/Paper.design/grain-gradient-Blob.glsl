// https://shaders.paper.design/grain-gradient (Blob)

// u_colorBack (vec4): Background color in RGBA
#define u_colorBack (vec4(0.059, 0.055, 0.094, 1.000))

// u_colors (vec4[]): Up to 7 gradient colors in RGBA
#define u_colors (vec4[7](\
	vec4(0.243, 0.380, 0.447, 1.000),\
	vec4(0.643, 0.608, 0.455, 1.000),\
	vec4(0.337, 0.549, 0.314, 1.000),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
	vec4(0)))
