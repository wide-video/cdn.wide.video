// https://shaders.paper.design/mesh-gradient (Beach)

// u_colors (vec4[]): Up to 10 color spots in RGBA
#define u_colors (vec4[10](\
	vec4(0.737, 0.925, 0.965, 1.000),\
	vec4(0.000, 0.667, 1.000, 1.000),\
	vec4(0.000, 0.969, 1.000, 1.000),\
	vec4(1.000, 0.831, 0.278, 1.000),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
