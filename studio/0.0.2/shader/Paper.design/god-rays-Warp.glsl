// https://shaders.paper.design/god-rays (Warp)

// u_colorBloom (vec4): Color overlay blended with the rays in RGBA
#define u_colorBloom (vec4(0.133, 0.133, 0.533, 1.000))
...
#define u_colors (vec4[5](\
	vec4(1.000, 0.278, 0.831, 1.000),\
	vec4(1.000, 0.549, 0.000, 1.000),\
