// https://shaders.paper.design/paper-texture (Details)

// u_colorFront (vec4): Foreground color in RGBA
#define u_colorFront (vec4(0.000, 0.000, 0.000, 0.000))
