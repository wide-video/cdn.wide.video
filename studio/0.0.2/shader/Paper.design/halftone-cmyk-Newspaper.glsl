// https://shaders.paper.design/halftone-cmyk (Newspaper)

// u_colorBack (vec4): Background (paper) color in RGBA
#define u_colorBack (vec4(0.949, 0.945, 0.910, 1.000))

// u_colorC (vec4): Cyan ink color in RGBA
#define u_colorC (vec4(0.478, 0.478, 0.459, 1.000))

// u_colorM (vec4): Magenta ink color in RGBA
#define u_colorM (vec4(0.478, 0.478, 0.459, 1.000))

// u_colorY (vec4): Yellow ink color in RGBA
#define u_colorY (vec4(0.478, 0.478, 0.459, 1.000))
