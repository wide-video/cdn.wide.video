// https://shaders.paper.design/warp (Passion)

// u_colors (vec4[]): Up to 10 gradient colors in RGBA
#define u_colors (vec4[10](\
	vec4(0.231, 0.082, 0.082, 1.000),\
	vec4(0.584, 0.278, 0.318, 1.000),\
	vec4(1.000, 0.753, 0.522, 1.000),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
