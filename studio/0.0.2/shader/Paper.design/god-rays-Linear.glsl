// https://shaders.paper.design/god-rays (Linear)

// u_colorBloom (vec4): Color overlay blended with the rays in RGBA
#define u_colorBloom (vec4(0.933, 0.933, 0.933, 1.000))
...
#define u_colors (vec4[5](\
	vec4(1.000, 1.000, 1.000, 0.122),\
	vec4(1.000, 1.000, 1.000, 0.239),\
	vec4(1.000, 1.000, 1.000, 0.161),\
	vec4(0),\
	vec4(0)))
...
#define u_offsetX 0.2

// u_offsetY (float): Vertical offset of the graphics center (-1 to 1)
#define u_offsetY -0.8
