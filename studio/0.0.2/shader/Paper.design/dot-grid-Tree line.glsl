// https://shaders.paper.design/dot-grid (Tree line)

// u_colorBack (vec4): Background color in RGBA
#define u_colorBack (vec4(0.957, 0.988, 0.906, 1.000))

// u_colorFill (vec4): Shape fill color in RGBA
#define u_colorFill (vec4(0.020, 0.180, 0.098, 1.000))

// u_colorStroke (vec4): Shape stroke color in RGBA
#define u_colorStroke (vec4(0.000, 0.000, 0.000, 1.000))
