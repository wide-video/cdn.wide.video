// https://shaders.paper.design/pulsing-border (Northern lights)

// u_colorBack (vec4): Background color in RGBA
#define u_colorBack (vec4(0.047, 0.094, 0.173, 1.000))

// u_colors (vec4[]): Up to 5 spot colors in RGBA
#define u_colors (vec4[5](\
	vec4(0.298, 0.278, 0.580, 1.000),\
	vec4(0.467, 0.290, 0.490, 1.000),\
	vec4(0.071, 0.412, 0.290, 1.000),\
	vec4(0.039, 1.000, 0.471, 1.000),\
	vec4(0.278, 0.200, 0.800, 1.000)))

// u_colorsCount (float): Number of active colors
#define u_colorsCount 5.

// u_roundness (float): Border radius (0 to 1)
#define u_roundness 0.

// u_thickness (float): Border base width (0 to 1)
#define u_thickness 1.
