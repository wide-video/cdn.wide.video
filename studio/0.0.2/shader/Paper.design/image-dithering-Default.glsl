// https://shaders.paper.design/image-dithering (Default)

// u_colorFront (vec4): Foreground color in RGBA
#define u_colorFront (vec4(0.580, 1.000, 0.686, 1.000))

// u_colorBack (vec4): Background color in RGBA
#define u_colorBack (vec4(0.000, 0.047, 0.220, 1.000))

// u_colorHighlight (vec4): Secondary foreground color in RGBA (set same as colorFront for classic 2-color dithering)
#define u_colorHighlight (vec4(0.918, 1.000, 0.580, 1.000))
