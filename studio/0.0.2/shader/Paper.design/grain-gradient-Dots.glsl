// https://shaders.paper.design/grain-gradient (Dots)
...
#define u_colors (vec4[7](\
	vec4(0.435, 0.000, 0.000, 1.000),\
	vec4(0.000, 0.502, 1.000, 1.000),\
	vec4(0.949, 0.922, 0.788, 1.000),\
	vec4(0.200, 0.800, 0.200, 1.000),\
	vec4(0),\
	vec4(0),\
	vec4(0)))
