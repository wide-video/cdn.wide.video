// https://shaders.paper.design/dot-orbit (Default)
...
#define u_colors (vec4[10](\
	vec4(1.000, 0.788, 0.420, 1.000),\
	vec4(1.000, 0.384, 0.000, 1.000),\
	vec4(1.000, 0.184, 0.000, 1.000),\
	vec4(0.259, 0.067, 0.000, 1.000),\
	vec4(0.102, 0.000, 0.000, 1.000),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
