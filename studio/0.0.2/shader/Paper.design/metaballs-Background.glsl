// https://shaders.paper.design/metaballs (Background)

// u_colorBack (vec4): Background color in RGBA
#define u_colorBack (vec4(0.165, 0.153, 0.247, 1.000))

// u_colors (vec4[]): Up to 8 base colors in RGBA
#define u_colors (vec4[8](\
	vec4(0.682, 0.000, 1.000, 1.000),\
	vec4(0.000, 1.000, 0.584, 1.000),\
