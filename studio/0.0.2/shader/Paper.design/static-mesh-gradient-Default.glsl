// https://shaders.paper.design/static-mesh-gradient (Default)

// u_colors (vec4[]): Up to 10 gradient colors in RGBA
#define u_colors (vec4[10](\
	vec4(1.000, 0.678, 0.039, 1.000),\
	vec4(0.384, 0.000, 1.000, 1.000),\
	vec4(0.886, 0.639, 1.000, 1.000),\
	vec4(1.000, 0.600, 0.992, 1.000),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
