// https://shaders.paper.design/grain-gradient (Truchet)

// u_colorBack (vec4): Background color in RGBA
#define u_colorBack (vec4(0.039, 0.000, 0.000, 1.000))

// u_colors (vec4[]): Up to 7 gradient colors in RGBA
#define u_colors (vec4[7](\
	vec4(0.435, 0.133, 0.000, 1.000),\
	vec4(0.918, 0.733, 0.486, 1.000),\
	vec4(0.224, 0.710, 0.137, 1.000),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
	vec4(0)))
