// https://shaders.paper.design/grain-gradient (Wave)

// u_colorBack (vec4): Background color in RGBA
#define u_colorBack (vec4(0.000, 0.039, 0.059, 1.000))

// u_colors (vec4[]): Up to 7 gradient colors in RGBA
#define u_colors (vec4[7](\
	vec4(0.769, 0.451, 0.043, 1.000),\
	vec4(0.741, 0.678, 0.373, 1.000),\
	vec4(0.847, 0.800, 0.780, 1.000),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
	vec4(0)))
