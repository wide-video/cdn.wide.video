// https://shaders.paper.design/paper-texture (Default)

// u_colorFront (vec4): Foreground color in RGBA
#define u_colorFront (vec4(0.624, 0.678, 0.737, 1.000))
