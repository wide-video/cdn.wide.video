// https://shaders.paper.design/static-radial-gradient (Lo-Fi)

// u_colorBack (vec4): Background color in RGBA
#define u_colorBack (vec4(0.180, 0.122, 0.153, 1.000))

// u_colors (vec4[]): Up to 10 gradient colors in RGBA
#define u_colors (vec4[10](\
	vec4(0.843, 0.149, 0.220, 1.000),\
	vec4(0.247, 0.533, 0.773, 1.000),\
	vec4(0.957, 0.616, 0.216, 1.000),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
