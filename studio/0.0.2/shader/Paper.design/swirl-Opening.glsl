// https://shaders.paper.design/swirl (Opening)

// u_colorBack (vec4): Background color in RGBA
#define u_colorBack (vec4(1.000, 0.545, 0.380, 1.000))

// u_colors (vec4[]): Up to 10 stripe colors in RGBA
#define u_colors (vec4[10](\
	vec4(0.996, 1.000, 0.941, 1.000),\
	vec4(1.000, 0.847, 0.741, 1.000),\
	vec4(1.000, 0.545, 0.380, 1.000),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
