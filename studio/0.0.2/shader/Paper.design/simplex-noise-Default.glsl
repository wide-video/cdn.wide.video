// https://shaders.paper.design/simplex-noise (Default)

// u_colors (vec4[]): Up to 10 base colors in RGBA
#define u_colors (vec4[10](\
	vec4(0.267, 0.286, 0.812, 1.000),\
	vec4(1.000, 0.820, 0.878, 1.000),\
	vec4(0.976, 0.267, 0.275, 1.000),\
	vec4(1.000, 0.827, 0.420, 1.000),\
