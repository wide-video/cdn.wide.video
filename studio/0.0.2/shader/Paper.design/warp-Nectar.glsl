// https://shaders.paper.design/warp (Nectar)

// u_colors (vec4[]): Up to 10 gradient colors in RGBA
#define u_colors (vec4[10](\
	vec4(0.082, 0.075, 0.063, 1.000),\
	vec4(0.827, 0.659, 0.420, 1.000),\
	vec4(0.941, 0.929, 0.918, 1.000),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
