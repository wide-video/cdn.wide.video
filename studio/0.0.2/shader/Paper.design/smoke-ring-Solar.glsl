// https://shaders.paper.design/smoke-ring (Solar)
...
#define u_colors (vec4[10](\
	...
	vec4(1.000, 0.792, 0.039, 1.000),\
	vec4(0.988, 0.384, 0.012, 1.000),\
	vec4(0.988, 0.384, 0.012, 0.400),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
