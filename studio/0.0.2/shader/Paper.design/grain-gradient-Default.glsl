// https://shaders.paper.design/grain-gradient (Default)
...
#define u_colors (vec4[7](\
	vec4(0.451, 0.000, 1.000, 1.000),\
	vec4(0.922, 0.659, 1.000, 1.000),\
	vec4(0.000, 0.749, 1.000, 1.000),\
	vec4(0.165, 0.000, 1.000, 1.000),\
	vec4(0),\
	vec4(0),\
	vec4(0)))
