// https://shaders.paper.design/image-dithering (Retro)

// u_colorFront (vec4): Foreground color in RGBA
#define u_colorFront (vec4(0.933, 0.933, 0.933, 1.000))

// u_colorBack (vec4): Background color in RGBA
#define u_colorBack (vec4(0.329, 0.322, 1.000, 1.000))

// u_colorHighlight (vec4): Secondary foreground color in RGBA (set same as colorFront for classic 2-color dithering)
#define u_colorHighlight (vec4(0.933, 0.933, 0.933, 1.000))
