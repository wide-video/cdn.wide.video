// https://shaders.paper.design/static-radial-gradient (Radial)

// u_colorBack (vec4): Background color in RGBA
#define u_colorBack (vec4(0.149, 0.275, 0.325, 1.000))

// u_colors (vec4[]): Up to 10 gradient colors in RGBA
#define u_colors (vec4[10](\
	vec4(0.612, 0.169, 0.169, 1.000),\
	vec4(0.957, 0.635, 0.380, 1.000),\
