// https://shaders.paper.design/spiral (Jungle)

// u_colorBack (vec4): Background color in RGBA
#define u_colorBack (vec4(0.627, 0.937, 0.165, 1.000))

// u_colorFront (vec4): Foreground (ink) color in RGBA
#define u_colorFront (vec4(0.157, 0.545, 0.094, 1.000))

// u_density (float): Spacing falloff simulating perspective, 0 = flat spiral (0 to 1)
#define u_density 0.5
