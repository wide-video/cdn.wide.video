// https://shaders.paper.design/mesh-gradient (Default)

// u_colors (vec4[]): Up to 10 color spots in RGBA
#define u_colors (vec4[10](\
	vec4(0.878, 0.918, 1.000, 1.000),\
	vec4(0.141, 0.114, 0.604, 1.000),\
	vec4(0.969, 0.314, 0.573, 1.000),\
	vec4(0.624, 0.314, 0.827, 1.000),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
