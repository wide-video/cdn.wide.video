// https://shaders.paper.design/god-rays (Default)

// u_colorBloom (vec4): Color overlay blended with the rays in RGBA
#define u_colorBloom (vec4(0.000, 0.000, 1.000, 1.000))
...
#define u_colors (vec4[5](\
	vec4(0.651, 0.000, 1.000, 0.431),\
	vec4(0.384, 0.000, 1.000, 0.941),\
	vec4(1.000, 1.000, 1.000, 1.000),\
	vec4(0.200, 1.000, 0.961, 1.000),\
	vec4(0)))
