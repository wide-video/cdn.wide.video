// https://shaders.paper.design/fluted-glass (Abstract)

// u_colorBack (vec4): Background color in RGBA
#define u_colorBack (vec4(0.000, 0.000, 0.000, 0.000))

// u_colorShadow (vec4): Shadows color in RGBA
#define u_colorShadow (vec4(0.000, 0.000, 0.000, 1.000))

// u_colorHighlight (vec4): Highlights color in RGBA
#define u_colorHighlight (vec4(1.000, 1.000, 1.000, 1.000))
