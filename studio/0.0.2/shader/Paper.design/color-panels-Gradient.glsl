// https://shaders.paper.design/color-panels (Gradient)

// u_colors (vec4[]): Up to 7 RGBA colors used to color the panels
#define u_colors (vec4[7](\
	vec4(0.949, 1.000, 0.000, 1.000),\
	vec4(0.000, 0.000, 0.000, 0.000),\
	vec4(0.000, 0.000, 0.000, 0.000),\
	vec4(0.353, 0.008, 0.514, 1.000),\
	vec4(0.000, 0.369, 1.000, 1.000),\
	vec4(0),\
	vec4(0)))
...
#define u_colorBack (vec4(0.561, 1.000, 0.949, 1.000))
...
#define u_rotation 270.

// u_offsetX (float): Horizontal offset of the graphics center (-1 to 1)
#define u_offsetX 0.18
