// https://shaders.paper.design/grain-gradient (Ripple)

// u_colorBack (vec4): Background color in RGBA
#define u_colorBack (vec4(0.078, 0.039, 0.000, 1.000))

// u_colors (vec4[]): Up to 7 gradient colors in RGBA
#define u_colors (vec4[7](\
	vec4(0.435, 0.176, 0.000, 1.000),\
	vec4(0.533, 0.867, 0.682, 1.000),\
	vec4(0.173, 0.043, 0.114, 1.000),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
	vec4(0)))
