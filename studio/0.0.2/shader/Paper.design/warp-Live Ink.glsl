// https://shaders.paper.design/warp (Live Ink)

// u_colors (vec4[]): Up to 10 gradient colors in RGBA
#define u_colors (vec4[10](\
	vec4(0.067, 0.075, 0.078, 1.000),\
	vec4(0.624, 0.682, 0.671, 1.000),\
	vec4(0.953, 0.996, 0.906, 1.000),\
	vec4(0.953, 0.996, 0.906, 1.000),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
