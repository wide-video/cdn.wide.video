// https://shaders.paper.design/waves (Groovy)

// u_colorFront (vec4): Foreground color in RGBA
#define u_colorFront (vec4(0.988, 0.988, 0.933, 1.000))

// u_colorBack (vec4): Background color in RGBA
#define u_colorBack (vec4(1.000, 0.537, 0.420, 1.000))
