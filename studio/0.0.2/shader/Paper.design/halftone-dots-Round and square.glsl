// https://shaders.paper.design/halftone-dots (Round and square)

// u_colorFront (vec4): Foreground color in RGBA
#define u_colorFront (vec4(1.000, 0.502, 0.000, 1.000))

// u_colorBack (vec4): Background color in RGBA
#define u_colorBack (vec4(0.078, 0.078, 0.078, 1.000))
