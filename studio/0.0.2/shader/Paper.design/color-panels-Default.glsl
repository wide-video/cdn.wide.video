// https://shaders.paper.design/color-panels (Default)

// u_colors (vec4[]): Up to 7 RGBA colors used to color the panels
#define u_colors (vec4[7](\
	vec4(1.000, 0.616, 0.000, 1.000),\
	vec4(0.992, 0.310, 0.188, 1.000),\
	vec4(0.502, 0.608, 1.000, 1.000),\
	vec4(0.427, 0.180, 1.000, 1.000),\
	vec4(0.200, 0.227, 1.000, 1.000),\
	vec4(0.945, 0.361, 1.000, 1.000),\
	vec4(1.000, 0.835, 0.341, 1.000)))

// u_colorsCount (float): Number of active colors
#define u_colorsCount 7.
