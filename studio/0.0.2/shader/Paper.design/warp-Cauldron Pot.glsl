// https://shaders.paper.design/warp (Cauldron Pot)

// u_colors (vec4[]): Up to 10 gradient colors in RGBA
#define u_colors (vec4[10](\
	vec4(0.655, 0.898, 0.545, 1.000),\
	vec4(0.196, 0.267, 0.447, 1.000),\
	vec4(0.039, 0.094, 0.051, 1.000),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
