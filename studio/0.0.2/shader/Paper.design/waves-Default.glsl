// https://shaders.paper.design/waves (Default)

// u_colorFront (vec4): Foreground color in RGBA
#define u_colorFront (vec4(1.000, 0.733, 0.000, 1.000))
