// https://shaders.paper.design/smoke-ring (Line)
...
#define u_colors (vec4[10](\
	vec4(0.271, 0.251, 0.643, 1.000),\
	vec4(0.122, 0.910, 1.000, 1.000),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
