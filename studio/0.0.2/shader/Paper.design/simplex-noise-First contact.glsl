// https://shaders.paper.design/simplex-noise (First contact)

// u_colors (vec4[]): Up to 10 base colors in RGBA
#define u_colors (vec4[10](\
	vec4(0.910, 0.800, 0.902, 1.000),\
	vec4(0.071, 0.051, 0.133, 1.000),\
	vec4(0.267, 0.173, 0.267, 1.000),\
	vec4(0.902, 0.729, 0.729, 1.000),\
	vec4(1.000, 0.961, 0.961, 1.000),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
