// https://shaders.paper.design/color-panels (Glass)

// u_colors (vec4[]): Up to 7 RGBA colors used to color the panels
#define u_colors (vec4[7](\
	vec4(0.000, 0.812, 1.000, 1.000),\
	vec4(1.000, 0.176, 0.333, 1.000),\
	vec4(0.204, 0.780, 0.349, 1.000),\
	vec4(0.686, 0.322, 0.871, 1.000),\
	vec4(0),\
	vec4(0),\
	vec4(0)))
