// https://shaders.paper.design/warp (Default)

// u_colors (vec4[]): Up to 10 gradient colors in RGBA
#define u_colors (vec4[10](\
	vec4(0.071, 0.071, 0.071, 1.000),\
	vec4(0.580, 0.439, 1.000, 1.000),\
	vec4(0.071, 0.071, 0.071, 1.000),\
	vec4(0.533, 0.220, 1.000, 1.000),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
