// https://shaders.paper.design/swirl (Default)

// u_colorBack (vec4): Background color in RGBA
#define u_colorBack (vec4(0.200, 0.000, 0.000, 1.000))

// u_colors (vec4[]): Up to 10 stripe colors in RGBA
#define u_colors (vec4[10](\
	vec4(1.000, 0.820, 0.820, 1.000),\
	vec4(1.000, 0.541, 0.541, 1.000),\
	vec4(0.400, 0.000, 0.000, 1.000),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
