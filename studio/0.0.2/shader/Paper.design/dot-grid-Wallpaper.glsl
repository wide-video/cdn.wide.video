// https://shaders.paper.design/dot-grid (Wallpaper)

// u_colorBack (vec4): Background color in RGBA
#define u_colorBack (vec4(0.125, 0.251, 0.188, 1.000))

// u_colorFill (vec4): Shape fill color in RGBA
#define u_colorFill (vec4(0.000, 0.000, 0.000, 1.000))

// u_colorStroke (vec4): Shape stroke color in RGBA
#define u_colorStroke (vec4(0.741, 0.584, 0.357, 1.000))
