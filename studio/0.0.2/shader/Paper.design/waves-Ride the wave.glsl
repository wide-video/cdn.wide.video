// https://shaders.paper.design/waves (Ride the wave)

// u_colorFront (vec4): Foreground color in RGBA
#define u_colorFront (vec4(0.992, 1.000, 0.902, 1.000))

// u_colorBack (vec4): Background color in RGBA
#define u_colorBack (vec4(0.122, 0.122, 0.122, 1.000))
