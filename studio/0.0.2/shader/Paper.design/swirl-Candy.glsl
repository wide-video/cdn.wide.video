// https://shaders.paper.design/swirl (Candy)

// u_colorBack (vec4): Background color in RGBA
#define u_colorBack (vec4(1.000, 0.804, 0.400, 1.000))

// u_colors (vec4[]): Up to 10 stripe colors in RGBA
#define u_colors (vec4[10](\
	vec4(0.420, 0.737, 0.922, 1.000),\
	vec4(0.843, 0.702, 1.000, 1.000),\
	vec4(1.000, 0.624, 1.000, 1.000),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
