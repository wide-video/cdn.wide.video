// https://shaders.paper.design/static-mesh-gradient (1960s)

// u_colors (vec4[]): Up to 10 gradient colors in RGBA
#define u_colors (vec4[10](\
	vec4(0.000, 0.000, 0.000, 1.000),\
	vec4(0.031, 0.141, 0.000, 1.000),\
	vec4(0.694, 0.667, 0.569, 1.000),\
	vec4(0.557, 0.549, 0.082, 1.000),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
