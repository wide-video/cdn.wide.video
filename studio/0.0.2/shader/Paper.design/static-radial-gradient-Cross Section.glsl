// https://shaders.paper.design/static-radial-gradient (Cross Section)

// u_colorBack (vec4): Background color in RGBA
#define u_colorBack (vec4(0.239, 0.204, 0.545, 1.000))

// u_colors (vec4[]): Up to 10 gradient colors in RGBA
#define u_colors (vec4[10](\
	vec4(0.463, 0.471, 0.929, 1.000),\
	vec4(0.969, 0.722, 0.004, 1.000),\
	vec4(0.945, 0.529, 0.004, 1.000),\
	vec4(0.216, 0.627, 0.400, 1.000),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
	vec4(0),\
