// https://shaders.paper.design/god-rays (Ether)

// u_colorBloom (vec4): Color overlay blended with the rays in RGBA
#define u_colorBloom (vec4(1.000, 1.000, 1.000, 1.000))

// u_colorBack (vec4): Background color in RGBA
#define u_colorBack (vec4(0.035, 0.059, 0.114, 1.000))

// u_colors (vec4[]): Up to 5 ray colors in RGBA
#define u_colors (vec4[5](\
	vec4(0.078, 0.557, 1.000, 0.651),\
	vec4(0.769, 0.875, 0.996, 0.745),\
	vec4(0.137, 0.165, 0.278, 1.000),\
	vec4(0),\
	vec4(0)))
