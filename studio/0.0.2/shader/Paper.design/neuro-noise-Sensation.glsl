// https://shaders.paper.design/neuro-noise (Sensation)

// u_colorFront (vec4): Graphics highlight color in RGBA
#define u_colorFront (vec4(0.000, 0.784, 1.000, 1.000))

// u_colorMid (vec4): Graphics main color in RGBA
#define u_colorMid (vec4(0.984, 1.000, 0.000, 1.000))

// u_colorBack (vec4): Background color in RGBA
#define u_colorBack (vec4(0.545, 0.259, 1.000, 1.000))

// u_brightness (float): Luminosity of the crossing points (0 to 1)
#define u_brightness 0.19

// u_contrast (float): Sharpness of the bright-dark transition (0 to 1)
#define u_contrast 0.12
