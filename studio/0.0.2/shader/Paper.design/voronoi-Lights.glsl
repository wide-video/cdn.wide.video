// https://shaders.paper.design/voronoi (Lights)

// u_colors (vec4[]): Up to 5 base cell colors in RGBA
#define u_colors (vec4[5](\
	vec4(1.000, 1.000, 1.000, 0.988),\
	vec4(0.733, 1.000, 0.000, 1.000),\
