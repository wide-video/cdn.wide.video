// https://shaders.paper.design/halftone-cmyk (Default)

// u_colorBack (vec4): Background (paper) color in RGBA
#define u_colorBack (vec4(0.984, 0.980, 0.961, 1.000))

// u_colorC (vec4): Cyan ink color in RGBA
#define u_colorC (vec4(0.000, 0.706, 1.000, 1.000))

// u_colorM (vec4): Magenta ink color in RGBA
#define u_colorM (vec4(0.988, 0.318, 0.624, 1.000))

// u_colorY (vec4): Yellow ink color in RGBA
#define u_colorY (vec4(1.000, 0.847, 0.000, 1.000))
