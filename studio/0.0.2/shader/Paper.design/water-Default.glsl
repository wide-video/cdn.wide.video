// https://shaders.paper.design/water (Default)

// u_colorBack (vec4): Background color in RGBA
#define u_colorBack (vec4(0.565, 0.565, 0.565, 1.000))
