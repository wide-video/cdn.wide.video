// https://shaders.paper.design/paper-texture (Abstract)

// u_colorFront (vec4): Foreground color in RGBA
#define u_colorFront (vec4(0.000, 0.933, 1.000, 1.000))

// u_colorBack (vec4): Background color in RGBA
#define u_colorBack (vec4(1.000, 0.039, 0.506, 1.000))

// u_contrast (float): Blending behavior, sharper vs smoother color transitions (0 to 1)
#define u_contrast 0.85
...
#define u_crumpleSize 0.3

// u_foldCount (float): Number of folds (1 to 15)
#define u_foldCount 3.
